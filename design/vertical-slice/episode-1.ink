...
_· KPI (事多事少) — 太低被裁。太高升职——升职是处刑。_

_· 钱 (月固定工资 + 你帮我省的零碎) — 不够付房贷, 我必须辞职。_

_· 状态 (个人自由 + 身心健康) — 撑不住病倒, 6 次以上直接被辞退。_
...
_活过这一年 (52 周) 就赢——不是升职加薪那种赢, 是"熬过去"那种赢。_

_任意一个月 KPI 崩, 或者钱断, 或者病倒 7 次, 就 game over。_

_我妈不知道我在玩这种游戏。她以为我在大公司当 leader。_
...
// ----------------------------------------------------------------------------
// 触发: morning_briefing 结束后第 1 个 event 前
// 速度: 闪 (~3 行)
// 同框: Vivian (前景)
...
//   - episode-1.ink Day 1 的, 6 个被剧情 event 占用 (event_1_vivian
